...
class Makna extends StatefulWidget {
  @override
  _MaknaState createState() => _MaknaState();
}

class _MaknaState extends State<Makna> {
  ...
  void _setOptions() async {
    ...
    _correctAnswer =
        question.arti.isNotEmpty ? question.arti : question.arti_tm;

    final List<String> options = [];
    if (question.arti.isNotEmpty) options.add(question.arti);
    if (question.arti_tm.isNotEmpty) options.add(question.arti_tm);

    snapshot.forEach((element) {
      if (element.kata != question.kata) {
        final option = element.arti.isNotEmpty ? element.arti : element.arti_tm;
