...
class Campur extends StatefulWidget {
  @override
  _CampurState createState() => _CampurState();
}

class _CampurState extends State<Campur> {
    ...
    if (_currentQuestionIndex < 5) {
      ...
      snapshot.forEach((element) {
        if (element.kata != question.kata) {
          final option =
              element.arti.isNotEmpty ? element.arti : element.arti_tm;
